from magictryon_turbo.models import get_diffusion_wrapper, get_text_encoder_wrapper, get_vae_wrapper
...
class ODERegression(nn.Module):
    def __init__(self, args, device):
        ...
        See Sec 4.3 of magictryon_turbo https://arxiv.org/abs/2412.07772 for details
        """
        super().__init__()
