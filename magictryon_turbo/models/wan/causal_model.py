from magictryon_turbo.models.wan.wan_base.modules.attention import attention
from magictryon_turbo.models.wan.wan_base.modules.model import (
    WanRMSNorm,
    rope_apply,
    WanLayerNorm,
...
class CausalWanAttentionBlock(nn.Module):
    ...
    def forward(
        ...
        def cross_attn_ffn(x, context, line_token, context_lens, e, crossattn_cache=None):
            x = x + self.cross_attn(self.norm3(x), context, line_token,
        ...
        x = cross_attn_ffn(x, context, line_token, context_lens, e, crossattn_cache)
        return x
...
class CausalWanModel(ModelMixin, ConfigMixin):
    ...
    def __init__(self,
        ...
        # 新添加的 embedding 层（使用 zero_module）
    ...
    def _forward_inference(
        ...
        See Algorithm 2 of magictryon_turbo paper https://arxiv.org/abs/2412.07772 for details.
