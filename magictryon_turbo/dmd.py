from magictryon_turbo.models.model_interface import InferencePipelineInterface
...
from magictryon_turbo.loss import get_denoising_loss
...
class DMD(nn.Module):
    ...
    def critic_loss(self, 
        ...
        if self.args.denoising_loss_type == "flow":
            ...
            from magictryon_turbo.models.wan.wan_wrapper import WanDiffusionWrapper
